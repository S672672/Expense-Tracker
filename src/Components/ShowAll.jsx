...
export default function ShowAll({ title, amount, share, ShowIcon }) {
  return (
    <div className='w-full sm:w-1/2 md:w-1/3 lg:w-3/12 xl:w-3/12 h-24 bg-white flex items-center justify-between rounded-md px-4 my-2 mx-2 md:mx-4 lg:mx-6 xl:mx-8 flex-wrap shadow-md hover:bg-purple-100 cursor-pointer'>
